 ...
 * Original code by: Charles Reis, University of Washington, 2007.
 * http://www.cs.washington.edu/research/security/web-tripwire.html
 *
 * Updated by: Ryan Barnett, Trustwave's SpiderLabs, 2011
 * Added md5 hash checking of response bodies
 *
 */
...
WebTripwire.targetPageURL = "login.html?tripwirecheck=on";
  ...
  var handler = function() {
    ...
    if (req.readyState == 4 && req.status == 200) {
      ...
      if (responsetextHash != tripwireHash) {
        ...
        alert("WARNING - This web page has been modified since leaving the web server.  Your system may be infected with a Banking Trojan.");  // for debugging
	// alert(tripwireHash);
